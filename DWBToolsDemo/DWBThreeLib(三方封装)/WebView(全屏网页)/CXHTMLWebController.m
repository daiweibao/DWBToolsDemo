...
@interface CXHTMLWebController ()<UIWebViewDelegate>
//网页
...
@implementation CXHTMLWebController
...
//    }
    ...
    //判断html为空
    if ([NSString isNULL:self.htmlString]) {
        //网页不能打开
    ...
    //html网页加载
    NSString * htmlString = [NSString stringWithFormat:@"<head><body width=%fpx style=\"word-wrap:break-word;\"><style>img{max-width:%fpx !important;}</style></head>%@",SCREEN_WIDTH,SCREEN_WIDTH-15, self.htmlString];
