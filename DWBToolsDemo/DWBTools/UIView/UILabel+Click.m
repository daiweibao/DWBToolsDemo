...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    [self yb_getTapFrameWithTouchPoint:point result:^(NSString *string, NSRange range, NSInteger index) {
        ...
        if (weakSelf.delegate && [weakSelf.delegate respondsToSelector:@selector(dwb_attributeTapReturnString:range:index:)]) {
            [weakSelf.delegate dwb_attributeTapReturnString:string range:range index:index];
        }
